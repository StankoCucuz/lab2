...
-- /___/   /\     Timestamp: Wed Mar 16 13:03:26 2016
-- \   \  /  \ 
--  \___\/\___\
--             
...
-- Input file	: top.ngc
-- Output file	: D:\lprs2\lab2\HDL\synthesis\lab2\netgen\synthesis\top_synthesis.vhd
-- # of Entities	: 1
-- Design Name	: top
...
architecture Structure of top is
  ...
  signal dir_pixel_column_10_GND_5_o_LessThan_14_o : STD_LOGIC; 
  signal pix_clock_o_OBUF_23 : STD_LOGIC; 
  ...
  signal vga_top_i_char_addr_s : STD_LOGIC_VECTOR ( 5 downto 4 ); 
...
begin
  ...
  vga_top_i_vga_i_vga_sync_i_green_r_0 : FDRE
    port map (
      C => vga_top_i_vga_i_clk_s,
      CE => vga_top_i_vga_i_vga_sync_i_enable_s_119,
      D => dir_pixel_column_10_GND_5_o_LessThan_14_o,
      R => vga_top_i_vga_i_vga_sync_i_rst_n_i_inv,
  ...
  dir_pixel_column_10_GND_5_o_LessThan_14_o1 : LUT4
    generic map(
      INIT => X"0155"
    )
    port map (
      ...
      I2 => vga_top_i_vga_i_vga_sync_i_h_count_r(6),
      I3 => vga_top_i_vga_i_vga_sync_i_h_count_r(8),
      O => dir_pixel_column_10_GND_5_o_LessThan_14_o
    );
  dir_blue_0_1 : LUT6
    generic map(
  ...
  vga_top_i_char_rom_i_BRAM_MEM_I : char_rom_def
    port map (
      ...
      addr(6) => vga_top_i_char_addr_s(5),
      addr(5) => vga_top_i_char_addr_s(4),
      addr(4) => vga_top_i_char_addr_s(5),
      addr(3) => vga_top_i_char_addr_s(4),
